...
func notificationDestinationColumns() []*plugin.Column {
	return []*plugin.Column{
		...
		{Name: "created_at", Description: "Timestamp when the destination was created", Type: proto.ColumnType_TIMESTAMP},
		{Name: "id", Description: "ID of the channel", Type: proto.ColumnType_STRING},
		{Name: "last_sent", Description: "Timestamp when last notification was sent to destination", Type: proto.ColumnType_TIMESTAMP},
		...
		{Name: "updated_at", Description: "Timestamp when destination was last updated", Type: proto.ColumnType_TIMESTAMP},
